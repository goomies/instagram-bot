...
class App_KernelTestDebugContainer extends Container
{
    ...
    protected function getNewsControllerService()
    {
        ...
        $this->services['App\\Controller\\NewsController'] = $instance = new \App\Controller\NewsController(($this->privates['App\\Repository\\NewsRepository'] ?? ($this->privates['App\\Repository\\NewsRepository'] = new \App\Repository\NewsRepository())));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('68jgnx6ZQv', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ite6kfjnFh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 2), true, ($this->targetDir.''.'/App_KernelTestDebugContainerDeprecations.log'));
    }
    ...
    protected function getNewsRepositoryService()
    {
        ...
        return $this->privates['App\\Repository\\NewsRepository'] = new \App\Repository\NewsRepository();
    }
    ...
    {
        return $this->privates['sensio_framework_extra.converter.doctrine.orm'] = new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\DoctrineParamConverter(NULL, NULL);
    }
    ...
    protected function getSensioFrameworkExtra_Converter_ManagerService()
    {
        ...
        $instance->add(($this->privates['sensio_framework_extra.converter.doctrine.orm'] ?? ($this->privates['sensio_framework_extra.converter.doctrine.orm'] = new \Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\DoctrineParamConverter(NULL, NULL))), 0, 'doctrine.orm');
